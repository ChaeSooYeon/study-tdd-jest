 ...
 * 
 */
export type TLiveSaleStatus = "READY" | "BID_END" | "LIVE_ING" | "END";
type Props = {
  saleStatus: TLiveSaleStatus;
};
export const LiveStatusButton = ({ saleStatus }: Props) => {
  return saleStatus === "END" ? null : <div role="button">{saleStatus}</div>;
};
